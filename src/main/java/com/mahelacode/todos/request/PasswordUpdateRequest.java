...
public class PasswordUpdateRequest {
    ...
    @Size(min = 5,max = 30,message = "Old Password must be 5 chars long")
    private String oldPassword;

    @NotEmpty(message = "New Password is mandatory")
    @Size(min = 5,max = 30,message = "New Password must be 5 chars long")
    private String newPassword;

    @NotEmpty(message = "Confirmed Password is mandatory")
    @Size(min = 5,max = 30,message = "Confirmed Password must be 5 chars long")
